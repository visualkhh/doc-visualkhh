...
public class BoardController {
	...
	public ModelAndView detail_do(@RequestParam("seq") int seq)throws Exception{
	...
	public ModelAndView update_form(@RequestParam("seq") int seq)throws Exception{
		Board board = dao.detail(seq);
	...
	public ModelAndView update_do(Board board)throws Exception{
		dao.update(board);
		return new ModelAndView("redirect:/board_list.do");
	}
