...
<table width="850px" cellpadding="3px" cellspacing="0" border="1">
	...
	<c:forEach var="em" items="${list}">
		<tr>
			...
			<td align="center">			
				<a href="/struts_new_board/bbs/bbs.do?action=read&num=${em.num }&pageNum=${param.pageNum }&subject=${param.subject }&writer=${param.writer }">
...
<table  width="850px" cellpadding="0" cellspacing="0" border="0">
	<tr>
		<td align="left">&nbsp;
			<input type="button" value="글쓰기" onclick="javascript:location.href='/struts_new_board/bbs/writeForm.do'">
		</td>
		<td colspan="3" align="right">
			<form action="/struts_new_board/bbs/list.do?action=list" method="POST">
