...
<table border=0>
	...
	<tr>
		<td align=right bgcolor="yellow"><font size=2>취미 : </font></td>
		<td bgcolor="yellow">
			<input type="checkbox" name="taste" value="등산">등산
			<input type="checkbox" name="taste" value="게임">게임
			<input type="checkbox" name="taste" value="음악">음악
